...
INSERT IGNORE INTO `TB_OPTION` (`OPTION_ID`, `OPTION_DV_CD`, `OPTION_NAME`, `OPTION_CD`)
VALUES (1, '0001', '검정', '#000000'),
       (2, '0001', '핑크', '#ffcccc'),
       (3, '0001', '노랑', '#fdff9e'),
       (4, '0000', '따뜻한', NULL),
       (5, '0000', '평온한', NULL),
...
INSERT IGNORE INTO `TB_CATEGORY` (`CATEGORY_ID`, `CATEGORY_NAME`, `USE_YN`, `PARENT`, `DEPTH`, `REG_ID`, `REG_DT`,
                                  `MOD_ID`, `MOD_DT`)
VALUES (1, '서울', 'Y', 0, 1, 'admin', '2025-08-14 16:27:40', NULL, NULL),
       (2, '경기도', 'Y', 0, 1, 'admin', '2025-08-14 16:27:42', NULL, NULL),
       (3, '인천', 'Y', 0, 1, 'admin', '2025-08-14 16:27:44', NULL, NULL),
       (4, '대구', 'Y', 0, 1, 'admin', '2025-08-14 16:27:46', NULL, NULL),
       (5, '충청도', 'Y', 0, 1, 'admin', '2025-08-14 16:27:49', NULL, NULL),
       (6, '전라도', 'Y', 0, 1, 'admin', '2025-08-14 16:27:52', NULL, NULL),
       (7, '강남구', 'Y', 1, 2, 'admin', '2025-08-14 16:27:58', NULL, NULL),
       (8, '강북구', 'Y', 1, 2, 'admin', '2025-08-14 16:28:01', NULL, NULL),
       (9, '강서구', 'Y', 1, 2, 'admin', '2025-08-14 16:28:03', NULL, NULL),
       (10, '강동구', 'Y', 1, 2, 'admin', '2025-08-14 16:28:05', NULL, NULL),
       (11, '양천구', 'Y', 1, 2, 'admin', '2025-08-14 16:28:07', NULL, NULL),
       (12, '금천구', 'Y', 1, 2, 'admin', '2025-08-14 16:28:09', NULL, NULL),
       (13, '구로구', 'Y', 1, 2, 'admin', '2025-08-14 16:28:11', NULL, NULL),
       (14, '부천', 'Y', 2, 2, 'admin', '2025-08-14 16:28:15', 'admin', '2025-08-14 16:28:19'),
       (15, '양재동', 'Y', 7, 3, 'admin', '2025-08-14 16:28:26', NULL, NULL),
       (16, '삼성동', 'Y', 7, 3, 'admin', '2025-08-14 16:28:34', NULL, NULL),
       (17, '마곡', 'Y', 9, 3, 'admin', '2025-08-14 16:28:38', NULL, NULL),
       (18, '양평', 'Y', 9, 3, 'admin', '2025-08-14 16:28:40', NULL, NULL),
       (19, '영등포구', 'Y', 1, 2, 'admin', '2025-08-14 16:28:47', NULL, NULL),
       (20, '화곡', 'Y', 9, 3, 'admin', '2025-08-14 16:28:52', NULL, NULL),
       (21, '신정', 'Y', 9, 3, 'admin', '2025-08-14 16:28:56', NULL, NULL),
       (22, '신월동', 'Y', 11, 3, 'admin', '2025-08-14 16:29:19', NULL, NULL),
       (23, '목동', 'Y', 11, 3, 'admin', '2025-08-14 16:29:21', NULL, NULL),
       (24, '바밤바', 'Y', 15, 4, 'admin', '2025-08-14 16:29:25', NULL, NULL),
       (25, '별난바', 'Y', 15, 4, 'admin', '2025-08-14 16:29:38', NULL, NULL),
       (26, '쌍쌍바', 'Y', 15, 4, 'admin', '2025-08-14 16:29:40', NULL, NULL),
       (27, '토리', 'Y', 16, 4, 'admin', '2025-08-14 16:29:43', NULL, NULL),
       (28, '요정', 'Y', 16, 4, 'admin', '2025-08-14 16:29:47', NULL, NULL),
       (29, '파스타', 'Y', 17, 4, 'admin', '2025-08-14 16:29:54', NULL, NULL),
       (30, '피자', 'Y', 17, 4, 'admin', '2025-08-14 16:29:56', NULL, NULL),
       (31, '삼겹살', 'Y', 17, 4, 'admin', '2025-08-14 16:30:00', NULL, NULL);
